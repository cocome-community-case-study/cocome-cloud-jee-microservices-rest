 ...
 */
@Provider
public class ProductsServiceExceptionMapper implements ExceptionMapper<NotFoundException> {

	private final Logger LOG = Logger.getLogger(ProductsServiceExceptionMapper.class);
