...
public class TradingEnterpriseClient {
	...
	public Collection<TradingEnterpriseTO> findAll() throws MicroserviceException {
		try {
	...
	public TradingEnterpriseTO find(long id) throws MicroserviceException {
		try {
	...
	public long create(TradingEnterpriseTO enterprise) throws MicroserviceException {
		try {
	...
	public void update(TradingEnterpriseTO enterprise) throws MicroserviceException {
		try {
	...
	public void delete(TradingEnterpriseTO enterprise) throws MicroserviceException {
		try {
			this.webTarget.path("trading-enterprises").path(Long.toString(enterprise.getId()))
					.request().delete();
